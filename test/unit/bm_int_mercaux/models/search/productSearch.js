...
describe('ProductSearch model', function () {
    ...
    var ProductSearch = proxyquire('../../../../../cartridges/bm_mercaux/cartridge/models/search/productSearch', {
        ...
        '~/cartridge/models/search/productSortOptions': proxyquire('../../../../../cartridges/bm_mercaux/cartridge/models/search/productSortOptions', {
            '~/cartridge/scripts/util/collections': {
                map: mockCollections.map
            },
